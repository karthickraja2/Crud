...
*/
        ...
        public ActionResult Create(string  response)
        {
            ...
            new Employee { ID=1, Designation="HR"},
            new Employee { ID=2, Designation="Sales Department"},
            new Employee { ID=3, Designation="senior Engineer"},
            new Employee { ID=4, Designation="Engineer" },
            new Employee { ID=5, Designation="Trainee Engineer"},
            new Employee { ID=6, Designation="Testing"},
